...
export const a_getAllTransactionController = async (req, res) => {
  try {
    const { userId, role, type, frequency, startDate, endDate } = req.body;

    console.log(role, type, frequency, startDate, endDate);
